...
const HEADER_MAP = { TOP_BAR: TopBarPreview, TIMER: TimerPreview, PROGRESS_BAR: ProgressBarPreview };
const BODY_MAP = { PRODUCTS_IN_CART: ProductsInCartPreview };
const FOOTER_MAP = {
...
export default function PreviewSection({ spec, products = [], onProductsChange }) {
  ...
  const headerOrder = spec.header?.order ?? [];
    ...
    <div className={styles.wrap}>
      ...
      >
        <div className={styles.cartHeader} style={{ background: bgColor }}>
          {renderBlocks(HEADER_MAP, spec.header, headerOrder, {
